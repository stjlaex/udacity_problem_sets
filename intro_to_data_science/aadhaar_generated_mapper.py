...
logging.basicConfig(filename='aadhaar_mapper.log', format='%(message)s', level=logging.INFO, filemode='w')
...
def mapper():
    ...
    for line in sys.stdin:
        ...
        if items[0]!='Registrar' and len(items) == 12:
            print(items[4] + "\t" + items[8])
